<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getLogs.aspx.cs" Inherits="Popbill.Cashbill.Example.getLogs" %>
		...
		<div id="content">
			...
			<fieldset class="fieldset1">
				...
				<ul>
					...
					<% } else {	%>
					    <% foreach (Popbill.Cashbill.CashbillLog logInfo in logList) { %>
