<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getFlatRateState.aspx.cs" Inherits="Popbill.EasyFin.Bank.Example.getFlatRateState" %>
...
<div id="content">
	...
	<fieldset class="fieldset1">
		...
		<ul>
			...
			<% } else { %>
				<li>referenceID (계좌 아이디) : <%= flatRateInfo.referenceID %></li>
