...
<div id="content">
    ...
    <fieldset class="fieldset1">
        ...
        <ul>
            ...
            <li><a href="Example/paymentRequest1.aspx">paymentRequest</a> - 연동회원 무통장 입금신청</li>
            <li><a href="Example/getSettleResult1.aspx">getSettleResult</a> - 연동회원 무통장 입금신청 정보확인</li>
            <li><a href="Example/getPaymentHistory.aspx">getPaymentHistory</a> - 연동회원 포인트 결제내역 확인</li>
            <li><a href="Example/getUseHistory1.aspx">getUseHistory</a> - 연동회원 포인트 사용내역 확인</li>
            <li><a href="Example/refund1.aspx">refund</a> - 연동회원 포인트 환불신청</li>
            <li><a href="Example/getRefundHistory1.aspx">getRefundHistory</a> - 연동회원 포인트 환불내역 확인</li>
            <li><a href="Example/getRefundInfo1.aspx">getRefundInfo</a> - 환불 신청 상태 조회</li>
            <li><a href="Example/getRefundableBalance1.aspx">getRefundableBalance</a> - 환불 가능 포인트 조회</li>
        </ul>
    </fieldset>
    <br/>
    <fieldset class="fieldset1">
        ...
        <ul>
            ...
            <li><a href="Example/quitMember1.aspx">quitMember</a> - 팝빌 회원 탈퇴</li>
        </ul>
    </fieldset>
</div>
</body>
