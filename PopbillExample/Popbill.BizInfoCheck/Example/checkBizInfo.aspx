    ...
    <fieldset class="fieldset1">
        ...
        <ul>
            ...
            <% } else { %>
                ...
                <li>companyRegNum (법인등록번호): <%=result.companyRegNum%></li>
                <li>checkDT (기업정보조회일시) : <%=result.checkDT%></li>
                ...
                <li>closeDownTaxType (과세유형) : <%=result.closeDownTaxType%></li>
                <li>closeDownTaxTypeDate (과세유형 전환일자):<%=result.closeDownTaxTypeDate%></li>
