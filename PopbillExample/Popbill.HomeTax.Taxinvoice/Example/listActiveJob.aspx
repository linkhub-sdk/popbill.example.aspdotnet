<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listActiveJob.aspx.cs" Inherits="Popbill.HomeTax.Taxinvoice.Example.listActiveJob" %>
...
<div id="content">
    ...
    <fieldset class="fieldset1">
        ...
        <ul>
            ...
            <% } else { %>
                <% foreach (Popbill.HomeTax.HTTaxinvoiceJobState jobState in jobStateList)
                   { %>
                    <fieldset class="fieldset2">
                        ...
                        <ul>
                            ...
                            <li>queryType (전자세금계산서 유형) : <%= jobState.queryType %></li>
