<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getPaymentHistory.aspx.cs" Inherits="Popbill.Taxinvoice.Example.getPaymentHistory" %>
                ...
                { %>
                    <fieldset class="fieldset2">
                        ...
                        <ul>
                            ...
                            <li>productName (결제제 상품명) : <%= paymentHistory.productName %> </li>
