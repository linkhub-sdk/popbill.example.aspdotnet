<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getLogs.aspx.cs" Inherits="Popbill.Taxinvoice.Example.getLogs" %>
...
<div id="content">
    ...
    <fieldset class="fieldset1">
        ...
        <ul>
            ...
            <% } else { %>
                <% foreach (Popbill.Taxinvoice.TaxinvoiceLog logInfo in logList)
                   { %>
