<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getFiles.aspx.cs" Inherits="Popbill.Taxinvoice.Example.getFiles" %>
...
<div id="content">
    ...
    <fieldset class="fieldset1">
        ...
        <ul>
            ...
            <% } else { %>
                <% foreach (Popbill.Taxinvoice.AttachedFile fileInfo in fileList)
                   { %>
