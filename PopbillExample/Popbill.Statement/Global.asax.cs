/**
* 팝빌 전자명세서 API ASP.NET SDK Example
*
* ASP.NET SDK 연동환경 설정방법 안내 : https://docs.popbill.com/statement/tutorial/dotnet#asp
* 업데이트 일자 : 2020-08-06
* 연동기술지원 연락처 : 1600-9854 / 070-4304-2991
* 연동기술지원 이메일 : code@linkhub.co.kr
*
* <테스트 연동개발 준비사항>
* 1) 30, 34번 라인에 선언된 링크아이디(LinkID)와 비밀키(SecretKey)를
