<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listContact.aspx.cs" Inherits="Popbill.Statement.Example.listContact" %>
                   ...
                   { %>
                    <fieldset class="fieldset2">
                        ...
                        <ul>
                            ...
                            <li> email (다망자 메일) : <%= contactInfo.email %></li>
