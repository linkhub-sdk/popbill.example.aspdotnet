            ...
            <% } else { %>
                <fieldset class="fieldset2">
                    ...
                    <ul>
                        ...
                        <li> plusFriendID (검색용 아이디) : <%= sentResult.plusFriendID %></li>
                        ...
                        <% foreach (Popbill.Kakao.KakaoSentDetail detailInfo in sentResult.msgs)
                           { %>
                            <fieldset class="fieldset3">
                                ...
                                <ul>
                                    <li> state (상태코드) : <%= detailInfo.state %></li>
                                    <li> sendDT (전송일시) : <%= detailInfo.sendDT %></li>
                                    <li> result (알림톡/친구톡 카카오 결과코드) : <%= detailInfo.result %></li>
                                    <li> resultDT (전송결과 수신일시) : <%= detailInfo.resultDT %></li>
                                    ...
                                    <li> altContentType (대체문자 전송타입) : <%= detailInfo.altContentType %></li>
                                    <li> altSendDT (대체문자 전송일시) : <%= detailInfo.altSendDT %></li>
                                    <li> altResult (대체문자 통신사 결과코드) : <%= detailInfo.altResult %></li>
